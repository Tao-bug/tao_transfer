...
def change_img1(file, max_width=4100, max_height=2100, min_width=1600, min_height=1800):
...
if __name__ == '__main__':
    ...
    img_file = '/Users/tao/Desktop/test/test_dataset/rap'
