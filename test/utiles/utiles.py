...
def dataset_attribute_map(images_dict, dataset):
    ...
    # bag_stander_dict = {"有", "无"}
    bag_stander_dict = {"Null":"无", "attachment-Backpack":"有", "attachment-ShoulderBag":"有", "attachment-HandBag":"有", "attachment-WaistBag":"有","attachment-PlasticBag":"有","attachment-PaperBag":"有","attachment-Other":"无","HandBag":"有","ShoulderBag":"有","carryingMessengerBag":"有","carryingPlasticBags":"有","ackpack":"有","backpack":"有",}
    # headwear_stander_dict = {"有", "无"}
